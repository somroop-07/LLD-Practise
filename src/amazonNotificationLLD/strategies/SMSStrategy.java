...
import amazonNotificationLLD.Dispatcher.Dispatcher;
import amazonNotificationLLD.Dispatcher.SMSDispatcher;
import amazonNotificationLLD.entitites.Notification;
import amazonNotificationLLD.entitites.User;

public class SMSStrategy implements NotificationStrategy {
	
	Dispatcher smsDispatcher = new SMSDispatcher();
	...
	public void sendNotification(Notification notification, User user) {
		...
		smsDispatcher.submitTask(notification, user);
